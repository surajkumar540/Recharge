...
const RechargeConfirmationModal = ({ isOpen, onClose, formValues, onConfirm }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      ...
      {showSuccess && (
        <div className="bg-white rounded-lg p-6 shadow-xl z-50 text-center">
          ...
          <h3 className="text-xl font-bold text-gray-800 mb-2">Recharge Successful!</h3>
          <p className="text-gray-600">Your recharge has been processed successfully.</p>
        </div>
      )}

      {/* Confirmation Modal */}
      {!showSuccess && (
        <div className="bg-white rounded-lg p-6 shadow-xl max-w-md w-full" onClick={handleModalContentClick}>
          <h3 className="text-xl font-bold text-gray-800 mb-4">Confirm Your Recharge</h3>
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="flex flex-col">
              <label htmlFor="mpin" className="text-sm text-gray-600 mb-1">Enter MPIN</label>
              <input
                type="password"
                id="mpin"
                value={mpin}
